	...
	<body>
		...
		<div id="show-aluno" class="content scaffold-show" role="main">
			...
			<ol class="property-list aluno">
				...
				<g:if test="${alunoInstance?.emailAluno}">
				<li class="fieldcontain">
					<span id="emailAluno-label" class="property-label"><g:message code="aluno.emailAluno.label" default="Email Aluno" /></span>
					
						<span class="property-value" aria-labelledby="emailAluno-label"><g:fieldValue bean="${alunoInstance}" field="emailAluno"/></span>
